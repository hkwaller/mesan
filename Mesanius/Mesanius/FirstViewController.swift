...
class FirstViewController: UIViewController,UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate{
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        var tBBController: TabBarController = self.tabBarController as TabBarController
